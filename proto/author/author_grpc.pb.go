...
type AuthorServiceClient interface {
	...
	ListAuthors(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*ListAuthorsResponse, error)
...
func (c *authorServiceClient) ListAuthors(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*ListAuthorsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type AuthorServiceServer interface {
	...
	ListAuthors(context.Context, *empty.Empty) (*ListAuthorsResponse, error)
...
func (UnimplementedAuthorServiceServer) ListAuthors(context.Context, *empty.Empty) (*ListAuthorsResponse, error) {
...
func _AuthorService_ListAuthors_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthorServiceServer).ListAuthors(ctx, req.(*empty.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
